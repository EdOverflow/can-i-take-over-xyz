...
Statuspage | Vulnerable | `Visiting the subdomain will redirect user's to https://www.statuspage.io` | | [PR #105](https://github.com/EdOverflow/can-i-take-over-xyz/pull/105)          
