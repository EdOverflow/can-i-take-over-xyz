...
Statuspage                     | Vulnerable |  `Subdomain's CNAME should point to [unique_string].stspg-customer.com & visiting the subdomain should redirect user's to https://www.statuspage.io`     |             |   [Statuspage Documentation](https://help.statuspage.io/knowledge_base/topics/domain-ownership)          
