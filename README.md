...
Statuspage                     | Vulnerable |  `Subdomain's CNAME should point to [unique_string].stspg-customer.com & visiting the subdomain on browser should redirect user's to https://www.statuspage.io`     |             |   [Statuspage Documentation](https://help.statuspage.io/knowledge_base/topics/domain-ownership)          
